  ...
  return (
    <div className={style.bannerContainer}>
      ...
      <p className={style.paragraph}>
        ...
        hasta para usar en el día a día. <br /> Nuestros productos están
        diseñados para brindarte una experiencia de uso cómoda y duradera.
        Utilizamos materiales de alta calidad para que puedas tener el máximo
        rendimiento en tus actividades deportivas o simplemente para que luzcas
